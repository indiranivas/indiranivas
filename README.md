...
### 💼 Software Engineer Trainee — LevelShift

- 🚀 Working on AI-powered applications and real-world ML systems  
- ⚙️ Building Flask APIs integrated with ML models  
- 🗄️ Managing data pipelines using MySQL  
- 📊 Developing analytics dashboards for business insights
